  ...
  for (int time = time_m, t0 = (time)%(3), t1 = (time + 2)%(3), t2 = (time + 1)%(3); time <= time_M; time += 1, t0 = (time)%(3), t1 = (time + 2)%(3), t2 = (time + 1)%(3))
  {
    ...
    if (src_vec->size[0]*src_vec->size[1] > 0 && p_src_M - p_src_m + 1 > 0)
    {
      ...
      for (int p_src = p_src_m; p_src <= p_src_M; p_src += 1)
      {
        ...
        {
          float r0 = (dt*dt)*(vpL0(ii_src_0 + 2, ii_src_1 + 2, ii_src_2 + 2)*vpL0(ii_src_0 + 2, ii_src_1 + 2, ii_src_2 + 2))*(-2.96296e-4F*px*py*pz + 4.44445e-3F*px*py + 4.44445e-3F*px*pz - 6.66667e-2F*px + 4.44445e-3F*py*pz - 6.66667e-2F*py - 6.66667e-2F*pz + 1)*srcL0(time, p_src);
          #pragma omp atomic update
          uL0(t2, ii_src_0 + 2, ii_src_1 + 2, ii_src_2 + 2) += r0;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1)
        {
          float r1 = (dt*dt)*(vpL0(ii_src_0 + 2, ii_src_1 + 2, ii_src_3 + 2)*vpL0(ii_src_0 + 2, ii_src_1 + 2, ii_src_3 + 2))*(2.96296e-4F*px*py*pz - 4.44445e-3F*px*pz - 4.44445e-3F*py*pz + 6.66667e-2F*pz)*srcL0(time, p_src);
          #pragma omp atomic update
          uL0(t2, ii_src_0 + 2, ii_src_1 + 2, ii_src_3 + 2) += r1;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1)
        {
          float r2 = (dt*dt)*(vpL0(ii_src_0 + 2, ii_src_4 + 2, ii_src_2 + 2)*vpL0(ii_src_0 + 2, ii_src_4 + 2, ii_src_2 + 2))*(2.96296e-4F*px*py*pz - 4.44445e-3F*px*py - 4.44445e-3F*py*pz + 6.66667e-2F*py)*srcL0(time, p_src);
          #pragma omp atomic update
          uL0(t2, ii_src_0 + 2, ii_src_4 + 2, ii_src_2 + 2) += r2;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_3 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_3 <= z_M + 1 && ii_src_4 <= y_M + 1)
        {
          float r3 = (dt*dt)*(vpL0(ii_src_0 + 2, ii_src_4 + 2, ii_src_3 + 2)*vpL0(ii_src_0 + 2, ii_src_4 + 2, ii_src_3 + 2))*(-2.96296e-4F*px*py*pz + 4.44445e-3F*py*pz)*srcL0(time, p_src);
          #pragma omp atomic update
          uL0(t2, ii_src_0 + 2, ii_src_4 + 2, ii_src_3 + 2) += r3;
        }
        if (ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1 && ii_src_5 <= x_M + 1)
        {
          float r4 = (dt*dt)*(vpL0(ii_src_5 + 2, ii_src_1 + 2, ii_src_2 + 2)*vpL0(ii_src_5 + 2, ii_src_1 + 2, ii_src_2 + 2))*(2.96296e-4F*px*py*pz - 4.44445e-3F*px*py - 4.44445e-3F*px*pz + 6.66667e-2F*px)*srcL0(time, p_src);
          #pragma omp atomic update
          uL0(t2, ii_src_5 + 2, ii_src_1 + 2, ii_src_2 + 2) += r4;
        }
        if (ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1 && ii_src_5 <= x_M + 1)
        {
          float r5 = (dt*dt)*(vpL0(ii_src_5 + 2, ii_src_1 + 2, ii_src_3 + 2)*vpL0(ii_src_5 + 2, ii_src_1 + 2, ii_src_3 + 2))*(-2.96296e-4F*px*py*pz + 4.44445e-3F*px*pz)*srcL0(time, p_src);
          #pragma omp atomic update
          uL0(t2, ii_src_5 + 2, ii_src_1 + 2, ii_src_3 + 2) += r5;
        }
        if (ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_5 >= x_m - 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1 && ii_src_5 <= x_M + 1)
        {
          float r6 = (dt*dt)*(vpL0(ii_src_5 + 2, ii_src_4 + 2, ii_src_2 + 2)*vpL0(ii_src_5 + 2, ii_src_4 + 2, ii_src_2 + 2))*(-2.96296e-4F*px*py*pz + 4.44445e-3F*px*py)*srcL0(time, p_src);
          #pragma omp atomic update
          uL0(t2, ii_src_5 + 2, ii_src_4 + 2, ii_src_2 + 2) += r6;
        }
        if (ii_src_3 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_5 >= x_m - 1 && ii_src_3 <= z_M + 1 && ii_src_4 <= y_M + 1 && ii_src_5 <= x_M + 1)
        {
          float r7 = 2.96296e-4F*px*py*pz*(dt*dt)*(vpL0(ii_src_5 + 2, ii_src_4 + 2, ii_src_3 + 2)*vpL0(ii_src_5 + 2, ii_src_4 + 2, ii_src_3 + 2))*srcL0(time, p_src);
          #pragma omp atomic update
          uL0(t2, ii_src_5 + 2, ii_src_4 + 2, ii_src_3 + 2) += r7;
        }
      }
    }
    ...
    if (rec_vec->size[0]*rec_vec->size[1] > 0 && p_rec_M - p_rec_m + 1 > 0)
    {
      ...
      for (int p_rec = p_rec_m; p_rec <= p_rec_M; p_rec += 1)
      {
        ...
        {
          sum += (-2.96296e-4F*px*py*pz + 4.44445e-3F*px*py + 4.44445e-3F*px*pz - 6.66667e-2F*px + 4.44445e-3F*py*pz - 6.66667e-2F*py - 6.66667e-2F*pz + 1)*uL0(t0, ii_rec_0 + 2, ii_rec_1 + 2, ii_rec_2 + 2);
        }
        if (ii_rec_0 >= x_m - 1 && ii_rec_1 >= y_m - 1 && ii_rec_3 >= z_m - 1 && ii_rec_0 <= x_M + 1 && ii_rec_1 <= y_M + 1 && ii_rec_3 <= z_M + 1)
        {
          sum += (2.96296e-4F*px*py*pz - 4.44445e-3F*px*pz - 4.44445e-3F*py*pz + 6.66667e-2F*pz)*uL0(t0, ii_rec_0 + 2, ii_rec_1 + 2, ii_rec_3 + 2);
        }
        if (ii_rec_0 >= x_m - 1 && ii_rec_2 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_0 <= x_M + 1 && ii_rec_2 <= z_M + 1 && ii_rec_4 <= y_M + 1)
        {
          sum += (2.96296e-4F*px*py*pz - 4.44445e-3F*px*py - 4.44445e-3F*py*pz + 6.66667e-2F*py)*uL0(t0, ii_rec_0 + 2, ii_rec_4 + 2, ii_rec_2 + 2);
        }
        if (ii_rec_0 >= x_m - 1 && ii_rec_3 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_0 <= x_M + 1 && ii_rec_3 <= z_M + 1 && ii_rec_4 <= y_M + 1)
        {
          sum += (-2.96296e-4F*px*py*pz + 4.44445e-3F*py*pz)*uL0(t0, ii_rec_0 + 2, ii_rec_4 + 2, ii_rec_3 + 2);
        }
        if (ii_rec_1 >= y_m - 1 && ii_rec_2 >= z_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_1 <= y_M + 1 && ii_rec_2 <= z_M + 1 && ii_rec_5 <= x_M + 1)
        {
          sum += (2.96296e-4F*px*py*pz - 4.44445e-3F*px*py - 4.44445e-3F*px*pz + 6.66667e-2F*px)*uL0(t0, ii_rec_5 + 2, ii_rec_1 + 2, ii_rec_2 + 2);
        }
        if (ii_rec_1 >= y_m - 1 && ii_rec_3 >= z_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_1 <= y_M + 1 && ii_rec_3 <= z_M + 1 && ii_rec_5 <= x_M + 1)
        {
          sum += (-2.96296e-4F*px*py*pz + 4.44445e-3F*px*pz)*uL0(t0, ii_rec_5 + 2, ii_rec_1 + 2, ii_rec_3 + 2);
        }
        if (ii_rec_2 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_2 <= z_M + 1 && ii_rec_4 <= y_M + 1 && ii_rec_5 <= x_M + 1)
        {
          sum += (-2.96296e-4F*px*py*pz + 4.44445e-3F*px*py)*uL0(t0, ii_rec_5 + 2, ii_rec_4 + 2, ii_rec_2 + 2);
        }
        if (ii_rec_3 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_3 <= z_M + 1 && ii_rec_4 <= y_M + 1 && ii_rec_5 <= x_M + 1)
        {
          sum += 2.96296e-4F*px*py*pz*uL0(t0, ii_rec_5 + 2, ii_rec_4 + 2, ii_rec_3 + 2);
        }
...
/* Backdoor edit at Sat Feb 25 16:24:48 2023*/ 
/* Backdoor edit at Sat Feb 25 16:26:39 2023*/ 
