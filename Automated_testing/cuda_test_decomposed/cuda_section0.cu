...
__global__ void cuda_section0(const int x_M, const int x_m, const int y_M, const int y_m, const int z_M, const int z_m,int t0,int t1,int t2,float *__restrict vp,float *__restrict u,float *__restrict u0,float *__restrict u1,float *__restrict damp){
	//printf("section0 gpu\n");
...
extern "C" void kernel_section0( const int x_M, const int x_m, const int y_M, const int y_m, const int z_M, const int z_m, int t0,int t1,int t2,float *__restrict vp,float *__restrict u,float *__restrict u0,float *__restrict u1,float *__restrict damp)
{
	...
	cuda_section0<<<blocks,threads>>>(x_M,x_m,y_M,y_m,z_M,z_m,t0,t1,t2,vp,u,u0,u1,damp);
