...
extern double j0 (double) __asm__ ("" "__j0_finite") __attribute__ ((__nothrow__ ));


extern double y0 (double) __asm__ ("" "__y0_finite") __attribute__ ((__nothrow__ ));


extern double j1 (double) __asm__ ("" "__j1_finite") __attribute__ ((__nothrow__ ));


extern double y1 (double) __asm__ ("" "__y1_finite") __attribute__ ((__nothrow__ ));


extern double jn (int, double) __asm__ ("" "__jn_finite") __attribute__ ((__nothrow__ ));


extern double yn (int, double) __asm__ ("" "__yn_finite") __attribute__ ((__nothrow__ ));




extern double lgamma_r (double, int *) __asm__ ("" "__lgamma_r_finite") __attribute__ ((__nothrow__ ));
...
extern __inline __attribute__ ((__always_inline__)) __attribute__ ((__gnu_inline__)) double
__attribute__ ((__nothrow__ )) gamma (double __d)
{
  return __lgamma_r_finite (__d, &signgam);
}
...
# 169 "/usr/include/bits/math-finite.h" 3 4
extern double scalb (double, double) __asm__ ("" "__scalb_finite") __attribute__ ((__nothrow__ ));
...
extern float j0f (float) __asm__ ("" "__j0f_finite") __attribute__ ((__nothrow__ ));


extern float y0f (float) __asm__ ("" "__y0f_finite") __attribute__ ((__nothrow__ ));


extern float j1f (float) __asm__ ("" "__j1f_finite") __attribute__ ((__nothrow__ ));


extern float y1f (float) __asm__ ("" "__y1f_finite") __attribute__ ((__nothrow__ ));


extern float jnf (int, float) __asm__ ("" "__jnf_finite") __attribute__ ((__nothrow__ ));


extern float ynf (int, float) __asm__ ("" "__ynf_finite") __attribute__ ((__nothrow__ ));




extern float lgammaf_r (float, int *) __asm__ ("" "__lgammaf_r_finite") __attribute__ ((__nothrow__ ));
...
extern __inline __attribute__ ((__always_inline__)) __attribute__ ((__gnu_inline__)) float
__attribute__ ((__nothrow__ )) gammaf (float __d)
{
  return __lgammaf_r_finite (__d, &signgam);
}
...
extern long double j0l (long double) __asm__ ("" "__j0l_finite") __attribute__ ((__nothrow__ ));


extern long double y0l (long double) __asm__ ("" "__y0l_finite") __attribute__ ((__nothrow__ ));


extern long double j1l (long double) __asm__ ("" "__j1l_finite") __attribute__ ((__nothrow__ ));


extern long double y1l (long double) __asm__ ("" "__y1l_finite") __attribute__ ((__nothrow__ ));


extern long double jnl (int, long double) __asm__ ("" "__jnl_finite") __attribute__ ((__nothrow__ ));


extern long double ynl (int, long double) __asm__ ("" "__ynl_finite") __attribute__ ((__nothrow__ ));




extern long double lgammal_r (long double, int *) __asm__ ("" "__lgammal_r_finite") __attribute__ ((__nothrow__ ));
...
extern __inline __attribute__ ((__always_inline__)) __attribute__ ((__gnu_inline__)) long double
__attribute__ ((__nothrow__ )) gammal (long double __d)
{
  return __lgammal_r_finite (__d, &signgam);
}
...
float * __restrict data = ((void*)0);
float * __restrict data1 = ((void*)0);
float * __restrict data2 = ((void*)0);
float * __restrict data3 = ((void*)0);
float * __restrict data4 = ((void*)0);
#pragma omp target data map(alloc : data[0:meret]) map(alloc : data1[0:meret]) map(alloc : data2[0:meret]) map(alloc : data3[0:meret]) map(alloc : data4[0:meret]) map(from : out[0:meret]) map(from : out2[0:meret])
# 107 "mainso8.c"
{
  ...
  for (int x = 0; x < sizex ; x++)
  {
    for (int y = 0; y < sizey ; y++)
    {
      for (int z = 0; z < sizez ; z++)
      {
        ...
        data[(z) + (y)*sizez + (x)*sizez * sizey] = 1.0;
        data1[(z) + (y)*sizez + (x)*sizez * sizey] = 1.0;
        data2[(z) + (y)*sizez + (x)*sizez * sizey] = 1.0;
        data3[(z) + (y)*sizez + (x)*sizez * sizey] = 1.0;
        data4[(z) + (y)*sizez + (x)*sizez * sizey] = 1.0;
        out[(z) + (y)*sizez + (x)*sizez * sizey] = 0.0;
        out2[(z) + (y)*sizez + (x)*sizez * sizey] = 0.0;
  ...
  for (int x = 0; x < sizex - 2*window_size; x++)
  {
    for (int y = 0; y < sizey - 2*window_size; y++)
    {
      for (int z = 0; z < sizez - 2*window_size; z++)
      {
         ...
         float r10 = 1.0F/(data1[(z + 8) + (y + 8)*sizez + (x + 8)*sizez * sizey]*data1[(z + 8) + (y + 8)*sizez + (x + 8)*sizez * sizey]); out[(z + 8) + (y + 8)*sizez + (x + 8)*sizez * sizey] = (r9*data2[(z + 1) + (y + 1)*sizez + (x + 1)*sizez * sizey]*data3[(z + 8) + (y + 8)*sizez + (x + 8)*sizez * sizey] + r10*(-r8*(-2.0F*data3[(z + 8) + (y + 8)*sizez + (x + 8)*sizez * sizey]) - r8*data4[(z + 8) + (y + 8)*sizez + (x + 8)*sizez * sizey]) + 7.93650813e-6F*(-data3[(z + 8) + (y + 8)*sizez + (x + 4)*sizez * sizey] - data3[(z + 8) + (y + 4)*sizez + (x + 8)*sizez * sizey] - data3[(z + 4) + (y + 8)*sizez + (x + 8)*sizez * sizey] - data3[(z + 12) + (y + 8)*sizez + (x + 8)*sizez * sizey] - data3[(z + 8) + (y + 12)*sizez + (x + 8)*sizez * sizey] - data3[(z + 8) + (y + 8)*sizez + (x + 12)*sizez * sizey]) + 1.12874782e-4F*(data3[(z + 8) + (y + 8)*sizez + (x + 5)*sizez * sizey] + data3[(z + 8) + (y + 5)*sizez + (x + 8)*sizez * sizey] + data3[(z + 5) + (y + 8)*sizez + (x + 8)*sizez * sizey] + data3[(z + 11) + (y + 8)*sizez + (x + 8)*sizez * sizey] + data3[(z + 8) + (y + 11)*sizez + (x + 8)*sizez * sizey] + data3[(z + 8) + (y + 8)*sizez + (x + 11)*sizez * sizey]) + 8.8888891e-4F*(-data3[(z + 8) + (y + 8)*sizez + (x + 6)*sizez * sizey] - data3[(z + 8) + (y + 6)*sizez + (x + 8)*sizez * sizey] - data3[(z + 6) + (y + 8)*sizez + (x + 8)*sizez * sizey] - data3[(z + 10) + (y + 8)*sizez + (x + 8)*sizez * sizey] - data3[(z + 8) + (y + 10)*sizez + (x + 8)*sizez * sizey] - data3[(z + 8) + (y + 8)*sizez + (x + 10)*sizez * sizey]) + 7.11111128e-3F*(data3[(z + 8) + (y + 8)*sizez + (x + 7)*sizez * sizey] + data3[(z + 8) + (y + 7)*sizez + (x + 8)*sizez * sizey] + data3[(z + 7) + (y + 8)*sizez + (x + 8)*sizez * sizey] + data3[(z + 9) + (y + 8)*sizez + (x + 8)*sizez * sizey] + data3[(z + 8) + (y + 9)*sizez + (x + 8)*sizez * sizey] + data3[(z + 8) + (y + 8)*sizez + (x + 9)*sizez * sizey]) - 3.79629639e-2F*data3[(z + 8) + (y + 8)*sizez + (x + 8)*sizez * sizey])/(r8*r10 + r9*data2[(z + 1) + (y + 1)*sizez + (x + 1)*sizez * sizey]);
      }
    }
  }
Kill_stopper();
          ...
          for (int by = y; by < y + blocksize_y; by++)
            for (int bz = z; bz < z + blocksize_z; bz++)
            {
                ...
                bz < sizez - 2*window_size)
              {
                  ...
                  float r10 = 1.0F/(data1[(bz + 8) + (by + 8)*sizez + (bx + 8)*sizez * sizey]*data1[(bz + 8) + (by + 8)*sizez + (bx + 8)*sizez * sizey]); out2[(bz + 8) + (by + 8)*sizez + (bx + 8)*sizez * sizey] = (r9*data2[(bz + 1) + (by + 1)*sizez + (bx + 1)*sizez * sizey]*data3[(bz + 8) + (by + 8)*sizez + (bx + 8)*sizez * sizey] + r10*(-r8*(-2.0F*data3[(bz + 8) + (by + 8)*sizez + (bx + 8)*sizez * sizey]) - r8*data4[(bz + 8) + (by + 8)*sizez + (bx + 8)*sizez * sizey]) + 7.93650813e-6F*(-data3[(bz + 8) + (by + 8)*sizez + (bx + 4)*sizez * sizey] - data3[(bz + 8) + (by + 4)*sizez + (bx + 8)*sizez * sizey] - data3[(bz + 4) + (by + 8)*sizez + (bx + 8)*sizez * sizey] - data3[(bz + 12) + (by + 8)*sizez + (bx + 8)*sizez * sizey] - data3[(bz + 8) + (by + 12)*sizez + (bx + 8)*sizez * sizey] - data3[(bz + 8) + (by + 8)*sizez + (bx + 12)*sizez * sizey]) + 1.12874782e-4F*(data3[(bz + 8) + (by + 8)*sizez + (bx + 5)*sizez * sizey] + data3[(bz + 8) + (by + 5)*sizez + (bx + 8)*sizez * sizey] + data3[(bz + 5) + (by + 8)*sizez + (bx + 8)*sizez * sizey] + data3[(bz + 11) + (by + 8)*sizez + (bx + 8)*sizez * sizey] + data3[(bz + 8) + (by + 11)*sizez + (bx + 8)*sizez * sizey] + data3[(bz + 8) + (by + 8)*sizez + (bx + 11)*sizez * sizey]) + 8.8888891e-4F*(-data3[(bz + 8) + (by + 8)*sizez + (bx + 6)*sizez * sizey] - data3[(bz + 8) + (by + 6)*sizez + (bx + 8)*sizez * sizey] - data3[(bz + 6) + (by + 8)*sizez + (bx + 8)*sizez * sizey] - data3[(bz + 10) + (by + 8)*sizez + (bx + 8)*sizez * sizey] - data3[(bz + 8) + (by + 10)*sizez + (bx + 8)*sizez * sizey] - data3[(bz + 8) + (by + 8)*sizez + (bx + 10)*sizez * sizey]) + 7.11111128e-3F*(data3[(bz + 8) + (by + 8)*sizez + (bx + 7)*sizez * sizey] + data3[(bz + 8) + (by + 7)*sizez + (bx + 8)*sizez * sizey] + data3[(bz + 7) + (by + 8)*sizez + (bx + 8)*sizez * sizey] + data3[(bz + 9) + (by + 8)*sizez + (bx + 8)*sizez * sizey] + data3[(bz + 8) + (by + 9)*sizez + (bx + 8)*sizez * sizey] + data3[(bz + 8) + (by + 8)*sizez + (bx + 9)*sizez * sizey]) - 3.79629639e-2F*data3[(bz + 8) + (by + 8)*sizez + (bx + 8)*sizez * sizey])/(r8*r10 + r9*data2[(bz + 1) + (by + 1)*sizez + (bx + 1)*sizez * sizey]);;
# 213 "mainso8.c"
              }
            }
      }
...
struct Stopper * Stopper_root=((void*)0);
