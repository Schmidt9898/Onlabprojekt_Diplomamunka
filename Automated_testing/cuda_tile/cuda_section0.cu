...
//#define tilesize_y 2 
//#define tilesize_z 1 
//#define teamsize_x 16
//#define teamsize_y 8 
//#define teamsize_z 8 

//-Dblocksize_x = {} -Dblocksize_y = {} -Dblocksize_z = {} -Dtilesize_x =  {} -Dtilesize_y =  {} -Dtilesize_z =  {} -Dteamsize_x =  {}-Dteamsize_y =  {} -Dteamsize_z =  {} 
...
extern "C" void kernel_section0( const int x_M, const int x_m, const int y_M, const int y_m, const int z_M, const int z_m, int t0,int t1,int t2,float *vp,float *u,float *damp)
{
	...
	dim3 blocks((x_M-x_m-1)/teamsize_z+1,(y_M-y_m-1)/teamsize_y+1,(z_M-z_m-1)/teamsize_x+1);
