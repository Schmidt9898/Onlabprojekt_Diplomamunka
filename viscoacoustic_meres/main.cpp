...
int Forward(struct dataobj *__restrict b_vec, struct dataobj *__restrict damp_vec, const float dt, const float o_x, const float o_y, const float o_z, struct dataobj *__restrict p_vec, struct dataobj *__restrict qp_vec, struct dataobj *__restrict r_vec, struct dataobj *__restrict rec_vec, struct dataobj *__restrict rec_coords_vec, struct dataobj *__restrict src_vec, struct dataobj *__restrict src_coords_vec, struct dataobj *__restrict v_x_vec, struct dataobj *__restrict v_y_vec, struct dataobj *__restrict v_z_vec, struct dataobj *__restrict vp_vec, const int x_M, const int x_m, const int x_size, const int y_M, const int y_m, const int y_size, const int z_M, const int z_m, const int z_size, const int p_rec_M, const int p_rec_m, const int p_src_M, const int p_src_m, const int time_M, const int time_m, const int x0_blk0_size, const int x1_blk0_size, const int y0_blk0_size)
{
...
dataobj create_data(int size0, int size1, int size2, int size3, int elemsize) {
  dataobj a;
  a.data = new char[elemsize*size0*size1*size2*size3];
  a.size = new int[4];
  a.size[0] = size0;
  a.size[1] = size1;
  a.size[2] = size2;
